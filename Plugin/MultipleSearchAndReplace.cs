...
namespace MusicBeePlugin
{
    public partial class MultipleSearchAndReplace : PluginWindowTemplate
    {
        ...
        internal MultipleSearchAndReplace(Plugin tagToolsPluginParam) : base(tagToolsPluginParam)
        {
            InitializeComponent();
        }
        ...
        internal override void preMoveScaleControl(Control control)
        {
            if (control.Name == "loadComboBoxCustom")
                loadComboBoxCustom.Width = loadComboBoxCustom.Width - (int)Math.Round(7 * loadComboBoxCustom.Margin.Left - 7 * loadComboBoxCustom.Margin.Left / hDpiFontScaling);
        ...
        internal static string EncodeSearchReplaceTemplate(string searchTemplate, string replaceTemplate, bool useRegexes, bool caseSensetive)
        {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            sourceTagIdInt = (int)GetTagId(sourceTagListCustom.Text);
            sourcePropIdInt = (int)GetPropId(sourceTagListCustom.Text);
            destinationTagId = GetTagId(destinationTagListCustom.Text);
            ...
            if (loadComboBoxCustom.SelectedIndex > 0)
            {
                int index = loadComboBoxCustom.SelectedIndex;
        ...
        private void autoDestinationTagCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            if (autoDestinationTagCheckBox.Checked)
            {
                ...
                int destinationTagListSelectedIndex = destinationTagListCustom.SelectedIndex;
