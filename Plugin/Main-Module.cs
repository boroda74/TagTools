...
namespace MusicBeePlugin
{
    ...
    partial class Plugin
    {
        ...
        internal static Color ButtonMouseOverBorderColor;
        ...
        internal static Color ComboBoxButtonBorderColor;
        internal static Color ComboBoxButtonMouseOverBorderColor;
        internal static Color ComboBoxButtonDisabledBorderColor;

        internal static Color ComboBoxButtonForeColor;
        internal static Color ComboBoxButtonBackColor;

        internal static Color ComboBoxButtonMouseOverForeColor;
        internal static Color ComboBoxButtonMouseOverBackColor;

        internal static Color ComboBoxButtonDisabledForeColor;
        internal static Color ComboBoxButtonDisabledBackColor;
        ...
        internal static Bitmap MouseOverGear;
        ...
        internal static SwappedTags SwapTags(string sourceTagValue, string origDestinationTagValue, string destinationTagValue, MetaDataType sourceTagId, MetaDataType destinationTagId,
            bool smartOperation, bool appendSourceToDestination = false, string appendedText = "", bool addSourceToDestination = false, string addedText = "")
        {
            ...
            if (smartOperation)
            {
                ...
                swappedTags.destinationNormalizedTagValue = GetTagRepresentation(origDestinationTagValue);
            ...
            else
            {
                ...
                swappedTags.destinationNormalizedTagValue = origDestinationTagValue;
        ...
        internal void prepareThemedBitmapsIconsColors()
        {
            ...
            if (!SavedSettings.dontUseSkinColors)
            {
                ...
                if (buttonDisabledForeColorCode == 0) //Unsupported by older API
                    ButtonDisabledForeColor = GetWeightedColor(ButtonForeColor, ButtonDisabledBackColor);
                else if (buttonDisabledForeColorCode == -1) //Windows color scheme
                ...
                if (buttonBorderCode == 0) //Unsupported by older API
                    ButtonDisabledBorderColor = ButtonDisabledForeColor;
                else if (buttonDisabledBorderColorCode == -1) //Windows color scheme
                    ButtonDisabledBorderColor = SystemColors.ControlText;
                else
                    ButtonDisabledBorderColor = Color.FromArgb(buttonDisabledBorderColorCode);

                if (buttonMouseOverBorderColorCode == 0) //Unsupported by older API
                    ButtonMouseOverBorderColor = ButtonMouseOverForeColor;
                if (buttonMouseOverBorderColorCode == -1) //Windows color scheme
                    ButtonMouseOverBorderColor = SystemColors.ControlText;
                else
                ...
                if (buttonMouseOverBackColorCode == 0)
                    ...
                    ComboBoxButtonBorderColor = SystemColors.Control;
                else
            ...
            else
            {
                ...
                ButtonBackColor = SystemColors.ButtonFace; //Used to color button images
                ButtonForeColor = SystemColors.ControlText; //Used to color button images
                ...
                ButtonMouseOverBackColor = SystemColors.ButtonFace; //Used to color button images
                ButtonMouseOverForeColor = SystemColors.ControlText; //Used to color button images
            ...
            if (!SavedSettings.dontUseSkinColors) //It's in case if skinned & not skinned buttons use different flat styles
            {
                ...
                DisabledDownArrowComboBoxImage?.Dispose();
                DisabledDownArrowComboBoxImage = GetSolidImageByBitmapMask(ComboBoxButtonDisabledForeColor,
                    Resources.down_arrow_combobox_b, scrollBarImagesWidth, scrollBarImagesWidth);


                MouseOverDownArrowComboBoxImage?.Dispose();
                MouseOverDownArrowComboBoxImage = GetSolidImageByBitmapMask(ComboBoxButtonMouseOverForeColor,
                    Resources.down_arrow_combobox_b, scrollBarImagesWidth, scrollBarImagesWidth);


                DownArrowComboBoxImage?.Dispose();
                DownArrowComboBoxImage = GetSolidImageByBitmapMask(ComboBoxButtonForeColor,
                    Resources.down_arrow_combobox_b, scrollBarImagesWidth, scrollBarImagesWidth);
                ...
                MouseOverGear?.Dispose();
                MouseOverGear = GetSolidImageByBitmapMask(ButtonMouseOverForeColor, Resources.gear, size, size);
            ...
            if (!SavedSettings.dontUseSkinColors)
            {
                ...
                int selectionForeColorCode = MbApiInterface.Setting_GetSkinElementColour(SkinElement.SkinInputControl, ElementState.ElementStateHighlight,
                    ElementComponent.ComponentForeground);
                var selectionForeColor = Color.FromArgb(selectionForeColorCode);
                int selectionBackColorCode = MbApiInterface.Setting_GetSkinElementColour(SkinElement.SkinInputControl, ElementState.ElementStateHighlight,
                    ElementComponent.ComponentBackground);
                var selectionBackColor = Color.FromArgb(selectionBackColorCode);
