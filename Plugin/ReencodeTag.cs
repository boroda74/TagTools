...
namespace MusicBeePlugin
{
    public partial class ReEncodeTag : PluginWindowTemplate
    {
        ...
        public ReEncodeTag(Plugin plugin) : base(plugin)
        {
            ...
            WindowMenuIcon = ReencodeTagMenuIcon;
            WindowIcon = ReencodeTagIcon;
            WindowIconInactive = ReencodeTagIconInactive;
        ...
        private void applyChanges()
        {
            ...
            for (var i = 0; i < tags.Count; i++)
            {
                ...
                if (isChecked == ColumnCheckedState)
                {
                    ...
                    SetStatusBarTextForFileOperations(this, ReEncodeTagSbText, false, i, tags.Count, currentFile);
